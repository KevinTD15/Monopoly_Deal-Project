...
class Mazo(Cartas):
    ...
    ilinois        = Propiedades('ilinois', 'propiedad', ['roja'], 3, [2,3,6], 3)
    indiana        = Propiedades('indiana', 'propiedad', ['roja'], 3, [2,3,6], 3)
    kentucky       = Propiedades('kentucky', 'propiedad', ['roja'], 3, [2,3,6], 3)    
